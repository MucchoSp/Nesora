...
#define NSあ			0x01			//音諳コードあ
#define NSい			0x02			//音諳コードい
#define NSや			0x03			//音諳コードや
#define NSゆ			0x04			//音諳コードゆ
#define NSいぇ			0x05			//音諳コードいぇ
#define NSよ			0x06			//音諳コードよ
#define NSう			0x07			//音諳コードう
#define NSわ			0x08			//音諳コードわ
#define NSゐ			0x09			//音諳コードゐ
#define NSうぃ			0x09			//音諳コードゐ
#define NSゑ			0x0a			//音諳コードゑ
#define NSうぇ			0x0a			//音諳コードゑ
#define NSを			0x0b			//音諳コードを
#define NSえ			0x0c			//音諳コードえ
#define NSお			0x0d			//音諳コードお
#define NS_0e			0x0e			//音諳コード未定義
#define NS_0f			0x0f			//音諳コード未定義

//破裂音
#define NSk				0x10			//音諳コードk
#define NSか			0x11			//音諳コードか
#define NSき			0x12			//音諳コードき
#define NSきゃ			0x13			//音諳コードきゃ
#define NSきゅ			0x14			//音諳コードきゅ
#define NSきぇ			0x15			//音諳コードきぇ
#define NSきょ			0x16			//音諳コードきょ
#define NSく			0x17			//音諳コードく
#define NSくゎ			0x18			//音諳コードくゎ
#define NSくぁ			0x18			//音諳コードくぁ
#define NSくぃ			0x19			//音諳コードくぃ
#define NSくぇ			0x1a			//音諳コードくぇ
#define NSくぉ			0x1b			//音諳コードくぉ
#define NSけ			0x1c			//音諳コードけ
#define NSこ			0x1d			//音諳コードこ
#define NS_1e			0x1e			//音諳コード未定義
#define NS_1f			0x1f			//音諳コード未定義

#define NSg				0x20			//音諳コードg
#define NSが			0x21			//音諳コードが
#define NSぎ			0x22			//音諳コードぎ
#define NSぎゃ			0x23			//音諳コードぎゃ
#define NSぎゅ			0x24			//音諳コードぎゅ
#define NSぎぇ			0x25			//音諳コードぎぇ
#define NSぎょ			0x26			//音諳コードぎょ
#define NSぐ			0x27			//音諳コードぐ
#define NSぐゎ			0x28			//音諳コードぐゎ
#define NSぐぁ			0x28			//音諳コードぐぁ
#define NSぐぃ			0x29			//音諳コードぐぃ
#define NSぐぇ			0x2a			//音諳コードぐぇ
#define NSぐぉ			0x2b			//音諳コードぐぉ
#define NSげ			0x2c			//音諳コードげ
#define NSご			0x2d			//音諳コードご
#define NS_2e			0x2e			//音諳コード未定義
#define NS_2f			0x2f			//音諳コード未定義

#define NSt				0x30			//音諳コードt
#define NSた			0x31			//音諳コードた
#define NSち			0x32			//音諳コードち
#define NSちゃ			0x33			//音諳コードちゃ
#define NSちゅ			0x34			//音諳コードちゅ
#define NSちぇ			0x35			//音諳コードちぇ
#define NSちょ			0x36			//音諳コードちょ
#define NSつ			0x37			//音諳コードつ
#define NSつゎ			0x38			//音諳コードつゎ
#define NSつぁ			0x38			//音諳コードつぁ
#define NSつぃ			0x39			//音諳コードつぃ
#define NSつぇ			0x3a			//音諳コードつぇ
#define NSつぉ			0x3b			//音諳コードつぉ
#define NSて			0x3c			//音諳コードて
#define NSと			0x3d			//音諳コードと
#define NS_3e			0x3e			//音諳コード未定義
#define NS_3f			0x3f			//音諳コード未定義

#define NSd				0x40			//音諳コードd
#define NSだ			0x41			//音諳コードだ
#define NSぢ			0x42			//音諳コードぢ
#define NSぢゃ			0x43			//音諳コードぢゃ
#define NSぢゅ			0x44			//音諳コードぢゅ
#define NSぢぇ			0x45			//音諳コードぢぇ
#define NSぢょ			0x46			//音諳コードぢょ
#define NSづ			0x47			//音諳コードづ
#define NSづゎ			0x48			//音諳コードづゎ
#define NSづぁ			0x48			//音諳コードづぁ
#define NSづぃ			0x49			//音諳コードづぃ
#define NSづぇ			0x4a			//音諳コードづぇ
#define NSづぉ			0x4b			//音諳コードづぉ
#define NSで			0x4c			//音諳コードで
#define NSど			0x4d			//音諳コードど
#define NS_4e			0x4e			//音諳コード未定義
#define NS_4f			0x4f			//音諳コード未定義

#define NSp				0x50			//音諳コードp
#define NSぱ			0x51			//音諳コードぱ
#define NSぴ			0x52			//音諳コードぴ
#define NSぴゃ			0x53			//音諳コードぴゃ
#define NSぴゅ			0x54			//音諳コードぴゅ
#define NSぴぇ			0x55			//音諳コードぴぇ
#define NSぴょ			0x56			//音諳コードぴょ
#define NSぷ			0x57			//音諳コードぷ
#define NSぷゎ			0x58			//音諳コードぷゎ
#define NSぷぁ			0x58			//音諳コードぷぁ
#define NSぷぃ			0x59			//音諳コードぷぃ
#define NSぷぇ			0x5a			//音諳コードぷぇ
#define NSぷぉ			0x5b			//音諳コードぷぉ
#define NSぺ			0x5c			//音諳コードぺ
#define NSぽ			0x5d			//音諳コードぽ
#define NS_5e			0x5e			//音諳コード未定義
#define NS_5f			0x5f			//音諳コード未定義

#define NSb				0x60			//音諳コードb
#define NSば			0x61			//音諳コードば
#define NSび			0x62			//音諳コードび
#define NSびゃ			0x63			//音諳コードびゃ
#define NSびゅ			0x64			//音諳コードびゅ
#define NSびぇ			0x65			//音諳コードびぇ
#define NSびょ			0x66			//音諳コードびょ
#define NSぶ			0x67			//音諳コードぶ
#define NSぶゎ			0x68			//音諳コードぶゎ
#define NSぶぁ			0x68			//音諳コードぶぁ
#define NSぶぃ			0x69			//音諳コードぶぃ
#define NSぶぇ			0x6a			//音諳コードぶぇ
#define NSぶぉ			0x6b			//音諳コードぶぉ
#define NSべ			0x6c			//音諳コードべ
#define NSぼ			0x6d			//音諳コードぼ
#define NS_6e			0x6e			//音諳コード未定義
#define NS_6f			0x6f			//音諳コード未定義

//摩擦音
#define NSs				0x70			//音諳コードs
#define NSさ			0x71			//音諳コードさ
#define NSし			0x72			//音諳コードし
#define NSしゃ			0x73			//音諳コードしゃ
#define NSしゅ			0x74			//音諳コードしゅ
#define NSしぇ			0x75			//音諳コードしぇ
#define NSしょ			0x76			//音諳コードしょ
#define NSす			0x77			//音諳コードす
#define NSすゎ			0x78			//音諳コードすゎ
#define NSすぁ			0x78			//音諳コードすぁ
#define NSすぃ			0x79			//音諳コードすぃ
#define NSすぇ			0x7a			//音諳コードすぇ
#define NSすぉ			0x7b			//音諳コードすぉ
#define NSせ			0x7c			//音諳コードせ
#define NSそ			0x7d			//音諳コードそ
#define NS_7e			0x7e			//音諳コード未定義
#define NS_7f			0x7f			//音諳コード未定義

#define NSz				0x80			//音諳コードz
#define NSざ			0x81			//音諳コードざ
#define NSじ			0x82			//音諳コードじ
#define NSじゃ			0x83			//音諳コードじゃ
#define NSじゅ			0x84			//音諳コードじゅ
#define NSじぇ			0x85			//音諳コードじぇ
#define NSじょ			0x86			//音諳コードじょ
#define NSず			0x87			//音諳コードず
#define NSずゎ			0x88			//音諳コードずゎ
#define NSずぁ			0x88			//音諳コードずぁ
#define NSずぃ			0x89			//音諳コードずぃ
#define NSずぇ			0x8a			//音諳コードずぇ
#define NSずぉ			0x8b			//音諳コードずぉ
#define NSぜ			0x8c			//音諳コードぜ
#define NSぞ			0x8d			//音諳コードぞ
#define NS_8e			0x8e			//音諳コード未定義
#define NS_8f			0x8f			//音諳コード未定義

#define NSh				0x90			//音諳コードh
#define NSは			0x91			//音諳コードは
#define NSひ			0x92			//音諳コードひ
#define NSひゃ			0x93			//音諳コードひゃ
#define NSひゅ			0x94			//音諳コードひゅ
#define NSひぇ			0x95			//音諳コードひぇ
#define NSひょ			0x96			//音諳コードひょ
#define NSふ			0x97			//音諳コードふ
#define NSふゎ			0x98			//音諳コードふゎ
#define NSふぁ			0x98			//音諳コードふぁ
#define NSふぃ			0x99			//音諳コードふぃ
#define NSふぇ			0x9a			//音諳コードふぇ
#define NSふぉ			0x9b			//音諳コードふぉ
#define NSへ			0x9c			//音諳コードへ
#define NSほ			0x9d			//音諳コードほ
#define NS_9e			0x9e			//音諳コード未定義
#define NS_9f			0x9f			//音諳コード未定義

//鼻音
#define NSn				0xa0			//音諳コードn
#define NSな			0xa1			//音諳コードな
#define NSに			0xa2			//音諳コードに
#define NSにゃ			0xa3			//音諳コードにゃ
#define NSにゅ			0xa4			//音諳コードにゅ
#define NSにぇ			0xa5			//音諳コードにぇ
#define NSにょ			0xa6			//音諳コードにょ
#define NSぬ			0xa7			//音諳コードぬ
#define NSぬゎ			0xa8			//音諳コードぬゎ
#define NSぬぁ			0xa8			//音諳コードぬぁ
#define NSぬぃ			0xa9			//音諳コードぬぃ
#define NSぬぇ			0xaa			//音諳コードぬぇ
#define NSぬぉ			0xab			//音諳コードぬぉ
#define NSね			0xac			//音諳コードね
#define NSの			0xad			//音諳コードの
#define NS_ae			0xae			//音諳コード未定義
#define NS_af			0xaf			//音諳コード未定義

#define NSm				0xb0			//音諳コードm
#define NSま			0xb1			//音諳コードま
#define NSみ			0xb2			//音諳コードみ
#define NSみゃ			0xb3			//音諳コードみゃ
#define NSみゅ			0xb4			//音諳コードみゅ
#define NSみぇ			0xb5			//音諳コードみぇ
#define NSみょ			0xb6			//音諳コードみょ
#define NSむ			0xb7			//音諳コードむ
#define NSむゎ			0xb8			//音諳コードむゎ
#define NSむぁ			0xb8			//音諳コードむぁ
#define NSむぃ			0xb9			//音諳コードむぃ
#define NSむぇ			0xba			//音諳コードむぇ
#define NSむぉ			0xbb			//音諳コードむぉ
#define NSめ			0xbc			//音諳コードめ
#define NSも			0xbd			//音諳コードも
#define NS_be			0xbe			//音諳コード未定義
#define NS_bf			0xbf			//音諳コード未定義

//はじき音
#define NSr				0xc0			//音諳コードr
#define NSら			0xc1			//音諳コードら
#define NSり			0xc2			//音諳コードり
#define NSりゃ			0xc3			//音諳コードりゃ
#define NSりゅ			0xc4			//音諳コードりゅ
#define NSりぇ			0xc5			//音諳コードりぇ
#define NSりょ			0xc6			//音諳コードりょ
#define NSる			0xc7			//音諳コードる
#define NSるゎ			0xc8			//音諳コードるゎ
#define NSるぁ			0xc8			//音諳コードるぁ
#define NSるぃ			0xc9			//音諳コードるぃ
#define NSるぇ			0xca			//音諳コードるぇ
#define NSるぉ			0xcb			//音諳コードるぉ
#define NSれ			0xcc			//音諳コードれ
#define NSろ			0xcd			//音諳コードろ
#define NS_ce			0xce			//音諳コード未定義
#define NS_cf			0xcf			//音諳コード未定義

//ん
#define NSnn			0xd0			//音諳コードnn
#define NSん1			0xd1			//音諳コードん1
#define NSん2			0xd2			//音諳コードん2
...
#define NS空			0xe1			//音諳コード空白
#define NS息			0xe2			//音諳コード息継
...
public:
	...
	int makeSinWave(int num, std::vector<double> Hz, std::vector<double> s, std::vector<double>& out, double a = 0.0, bool doformant = true);	//リストから合成されたsin波を生成
	int makeSinha(double Hz, double s, std::vector<double>& out);													//単純なsin波を生成

	int makeHarmonicOvertone(double bf);																			//基本倍音設定
	int setFormants(double F1, double F2, double F3, double F4);													//フォルマントリストに周波数を設定
	int makeFilter();																								//基本倍音の大きさを自動生成
	int makeSinWaveFromClass(std::vector<double>& out, double a = 0.0);												//クラス内のパラメータからsin波を合成

	double makeMomentSinWave(int num, std::vector<double> Hz, std::vector<double> s, int gets);												//特定の時間の周波数を取得
	double makeMomentSinWaveFromClass(int t);																		//クラス内のパラメータから特定の時間の周波数を取得


	double mostMax(std::vector<double> list);																	//配列内の最も大きい値を返す関数

	int hipassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double q);				//ハイパスフィルター
	int lowpassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double q);				//ローパスフィルター
	int notchpassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double bw);			//ノッチパスフィルター

	int debugtf(bool deb);																							//デバッグ表示するかどうか
	int getstate(int state);																						//現在のmainMakeVoiseF.cppの状態を取得する。
	int setSoftness(double sn);																						//softness変数を変更
private:

	int fsize = 4, hosize = 0;																						//フォルマントの数、倍音の数
	std::vector<double> formants = { 0.0,0.0,0.0,0.0 }, harmonicOvertones = { 0.0 }, harmonictoneFilters = { 0.0 };	//データ配列
	double bf = 0;																									//基底周波数
	double softness = 0;																							//柔らかさ
	bool debug = true;
...
public:
	...
	int textreading(const char* filename);																			//textreadで読み込んだ文章を読み上げ

	int saveData(const char* name, int bf, char formant[5][8], const int otherdatasize = 0, char* otherdatas = nullptr, int v = 0);//データを作る

	int loadFromChar(char* data);																					//文字列からデータを読み込み
	int loadVoise(const char* name);																				//ファイルからデータを読み込み

	double getPrivatebf();																							//データ保管庫から基音データを読み込む
	double getPrivatebFormant(int b, int f);																		//データ保管庫からフォルマントデータを読み込む

	int debugtf(bool deb);																							//デバッグ表示するかどうか

private:

	int saveData0(const char* name, int bf, char formants[5][8]);													//零号機のデータを保存
	int saveData2(const char* name, int bf, char* otherdatas);														//零号機弐型のデータを保存

	int decodeVoise0(char* data);																					//零号機のデータを読み込む
	int decodeVoise2(char* data);																					//零号機のデータを読み込む

	int makeWhitenoise(std::vector<double> out, int time, double hz, double um);									//ホワイトノイズを作成
	int makeWhitenoise1(std::vector<double> out, int time, double hz);												//ホワイトノイズを作成

	int hipassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double q);				//ハイパスフィルター
	int lowpassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double q);				//ローパスフィルター
	int notchpassFilter(std::vector<double> input, std::vector<double>& out, double samplerate, double freq, double bw);			//ノッチパスフィルター

	double privatebf = 0, privateFormant[5][4] = { 0 };																//makeVoiseFromFileのデータ保管庫
	double allmojiFormant[2][16][16][4] = { 0 };																	//文字のフォルマントの保管庫
	double softness = 0;																							//柔らかさの保管庫

	int createAllMojiFromantFromClass();																			//privateFormantからallmojiFormantを作成
	double getMojiFormant(int f, int moji, int formant);															//allmojiFormantからフォルマントを取得
	...
	void textreadingHanboin(std::vector<double>& out, NSCHAR nowmoji, double pitch, int targettime);
	void textreadingHaretuon(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, double pitch, int targettime);
	void textreadingYuuseiHaretuon(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, double pitch, int targettime, bool select = true);
	void textreadingMasatuon(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, double pitch, int targettime);
	void textreadingYuuseiMasatuon(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, double pitch, int targettime);
	void textreadingMASATUON(std::vector<double>& out, NSCHAR nowmoji, double pitch, int targettime);
	void textreadingBion(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, NSCHAR oldmoji, double pitch, int targettime);
	void textreadingHajikion(std::vector<double>& out, NSCHAR nowmoji1, NSCHAR nowmoji2, NSCHAR oldmoji, double pitch, int targettime);

	void textreadingBoin1(std::vector<double>& out, NSCHAR nowmoji, double pitch, int targettime);
	void textreadingBoin2(std::vector<double>& out, NSCHAR nowmoji, NSCHAR nextmoji, double pitch, double nextpitch, int targettime);
...
class mainMakeWAV {
public:
	int wav_write(const char* filename, unsigned char* buffer, size_t size);										//旧wavファイル作成関数
	int WriteWavFile(const char* filename, const char* buf, int size);												//wavファイル作成関数
};
