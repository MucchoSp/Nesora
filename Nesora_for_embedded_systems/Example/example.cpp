...
// 技術者用メモ
// 
// 後述の環境で「茶摘みの歌」(1分16秒、104文字)の音声を生成するのに約2.3秒かかりました。
// また、NS_USE_FAST_SIN_TABLEを有効にした場合に同様の音声を生成したところ、約1.8秒かかりましたが、生成された音声は20秒あたりから破綻しました。
// 
// さらに、「数字の読み上げ」(44秒、258文字)の音声を生成するのには、約4.0秒かかりました。
// 
// 
// 
// 以下、テスト環境です。
